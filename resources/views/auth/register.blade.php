...
@section('title', 'Register - Room Booking Platform')
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('name') }}" 
                           required
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors duration-200 @error('name') border-red-500 @enderror"
